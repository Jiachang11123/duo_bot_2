...
# ==========================================
DEFAULT_THREADS = 100    # 你要求的 100
DEFAULT_BATCH = 300      # 你要求的 300
DEFAULT_DELAY = 0.01     # 你要求的 0.01
NOTIFY_INTERVAL = 60
...
class DuoGemNuclear:
    def __init__(self, token, reward_id):
        ...
        self.start_time = 0
        self.initial_gems = 0
        self.avg_gems_per_hit = 15.0 # 預估值
